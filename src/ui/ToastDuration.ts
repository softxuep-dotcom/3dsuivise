 ...
 * 中文是这个项目的源语言，其余语言都是它的译文，而译文通常比原文长得多：
 *
 *     zh  4869 字    ja  5712    ko  7224    en 11136    tr 11208
 *     vi 11973       pt 12735    ru 12752    de 12822    es 12875
 *     it 12893       id 13259    fr 13321             （各 383 个键合计）
 *
 * 法文是中文的 **2.74 倍**。按各语种实际阅读速率折算，3.1 秒里读不完的比例：
 *
 *     zh 30.2%   ja 38.7%   en 40.3%   de 41.8%   fr 43.2%   id 43.4%
 *
 ...
 *
 *     de 7.8s  id/pt 7.1s  es/fr 7.0s  it 6.7s  vi 6.4s  ru 6.1s   ← 读不完
 *     ja 5.7s  tr 5.6s  ko 5.4s  en 5.3s  zh 4.1s                  ← 读得完
 *
 * **十三种里八种读不完开场那句**。而 msg.1 在 t=0
 * 出现时队列是空的 —— 它谁也没饿着，那 6 秒纯粹是白收的。
 *
 * SOLO 档取 8 秒而不是无限：此前对全部会走字幕的文案实测，
